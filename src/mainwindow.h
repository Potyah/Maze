...
private:
    ...
    void paintWay(double w_step, double h_step, std::vector<std::pair<int, int>> vec, QPen pen);
    ...
    // caves block
    int widthCaves_, heightCaves_, deathLimit_, birthLimit_, probability_, iteration_;
    void paintCells();
