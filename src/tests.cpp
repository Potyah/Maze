...
TEST(mazeTest, test3) { ASSERT_THROW(Labyrinth newLab(0, 0), std::invalid_argument); }
...
TEST(cellularTest, test1) { ASSERT_THROW(Cellular newCell(1, 51), std::out_of_range); }

TEST(cellularTest, test2) { ASSERT_THROW(Cellular newCell(10, 51, 3, 5, 2), std::out_of_range); }
...
TEST(cellularTest, test4) { ASSERT_THROW(Cellular newCell(-4, 1, 3, 5, 2), std::out_of_range); }
