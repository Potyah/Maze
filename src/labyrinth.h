...
public:
    ...
    std::vector<std::pair<int, int>> findWay(int rowNumberStart, int posInRowStart, int rowNumberEnd,
                                             int posInRowEnd);

private:
    bool recursionFind(std::tuple<bool, bool, bool, bool> side, std::pair<int, int> start,
